            ...
            <React.Fragment key={index}>
              <tr>
                ...
                <td className="border border-gray-300 p-2 text-right">
                  Bs. {Number(item.total_cost).toFixed(2)}
                </td>
              </tr>
                      ...
                      <tbody>
                        {item.PurchaseItems.map((detail, idx) => (
                          <tr key={idx}>
                            ...
                            <td className="text-right py-1">{formatCurrency(Number(detail.unit_cost))}</td>
                            <td className="text-right py-1">{formatCurrency(Number(Number(detail.quantity) * Number(detail.unit_cost)))}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
